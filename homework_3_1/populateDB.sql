...
INSERT INTO `hw2`.`projects` (`project_id`, `project_name`, `company_id`, `customer_id`) VALUES ('1', 'Domino', '1', '1');
INSERT INTO `hw2`.`projects` (`project_id`, `project_name`, `company_id`, `customer_id`) VALUES ('2', 'Opera 3', '1', '2');
INSERT INTO `hw2`.`projects` (`project_id`, `project_name`, `company_id`, `customer_id`) VALUES ('3', 'Integro', '2', '1');
INSERT INTO `hw2`.`projects` (`project_id`, `project_name`, `company_id`, `customer_id`) VALUES ('4', 'Anagramma', '2', '2');
INSERT INTO `hw2`.`projects` (`project_id`, `project_name`, `company_id`, `customer_id`) VALUES ('5', 'Diadas', '2', '3');
INSERT INTO `hw2`.`projects` (`project_id`, `project_name`, `company_id`, `customer_id`) VALUES ('6', 'DueForte', '3', '1');
INSERT INTO `hw2`.`projects` (`project_id`, `project_name`, `company_id`, `customer_id`) VALUES ('7', 'Thunder', '3', '2');
INSERT INTO `hw2`.`projects` (`project_id`, `project_name`, `company_id`, `customer_id`) VALUES ('8', 'BusinessGame', '3', '3');
